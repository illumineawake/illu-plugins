...
class AutoClickIllumineOverlay extends Overlay
{
	...
	private final AutoClickIllumine plugin;
	private final AutoClickIllumineConfig config;
	private int timeout;

	@Inject
	AutoClickIllumineOverlay(Client client, AutoClickIllumine plugin, AutoClickIllumineConfig config)
	{
