...
{
	//TREE GNOME
	GNOME_LOG(new WorldArea(new WorldPoint(2470, 3435, 0), new WorldPoint(2489, 3447, 0)), LOG_BALANCE_23145, RooftopAgilityObstacleType.GROUND_OBJECT),
	...
	GNOME_ROPE(new WorldArea(new WorldPoint(2469, 3416, 2), new WorldPoint(2479, 3423, 2)), BALANCING_ROPE_23557, RooftopAgilityObstacleType.GROUND_OBJECT),
	...
	//DRAYNOR
	DRAY_WALL(new WorldArea(new WorldPoint(3082, 3254, 0), new WorldPoint(3105, 3293, 0)), ROUGH_WALL, RooftopAgilityObstacleType.DECORATION),
	DRAY_TIGHTROPE(new WorldArea(new WorldPoint(3096, 3275, 3), new WorldPoint(3103, 3282, 3)), TIGHTROPE, RooftopAgilityObstacleType.GROUND_OBJECT),
	DRAY_TIGHTROPE_TWO(new WorldArea(new WorldPoint(3086, 3271, 3), new WorldPoint(3093, 3279, 3)), TIGHTROPE_11406, RooftopAgilityObstacleType.GROUND_OBJECT),
	...
	//VARROCK
	COURSE_GROUND(new WorldArea(new WorldPoint(3184, 3386, 0), new WorldPoint(3243, 3428, 0)),ROUGH_WALL_14412, RooftopAgilityObstacleType.DECORATION),
	...
	//FALADOR
	FAL_GROUND(new WorldArea(new WorldPoint(3008, 3328, 0), new WorldPoint(3071, 3391, 0)), ROUGH_WALL_14898, RooftopAgilityObstacleType.DECORATION),
	FAL_ROOFTOP_ONE(new WorldArea(new WorldPoint(3034, 3342, 3), new WorldPoint(3040, 3347, 3)),TIGHTROPE_14899, RooftopAgilityObstacleType.GROUND_OBJECT),
	...
	FAL_ROOFTOP_SIX(new WorldArea(new WorldPoint(3025, 3352, 3), new WorldPoint(3029, 3355, 3)),TIGHTROPE_14911, RooftopAgilityObstacleType.GROUND_OBJECT),
	...
	//SEERS
	SEERS_GROUND(new WorldArea(new WorldPoint(2689, 3457, 0), new WorldPoint(2750, 3517, 0)), WALL_14927, RooftopAgilityObstacleType.DECORATION),
	SEERS_ROOF_ONE(new WorldArea(new WorldPoint(2720, 3489, 3), new WorldPoint(2731, 3498, 3)), GAP_14928),
	SEERS_ROOF_TWO(new WorldArea(new WorldPoint(2702, 3486, 2), new WorldPoint(2714, 3499, 2)), TIGHTROPE_14932, RooftopAgilityObstacleType.GROUND_OBJECT),
	...
	//Rellekka
	RELL_GROUND(new WorldArea(new WorldPoint(2612, 3654, 0), new WorldPoint(2672, 3687, 0)), ROUGH_WALL_14946, RooftopAgilityObstacleType.DECORATION),
	...
	//Pollniveach
	POLL_GROUND(new WorldArea(new WorldPoint(3328, 2944, 0), new WorldPoint(3392, 3008, 0)), BASKET_14935),
	POLL_ROOF_ONE(new WorldArea(new WorldPoint(3346, 2963, 1), new WorldPoint(3352, 2969, 1)), MARKET_STALL_14936),
	POLL_ROOF_TWO(new WorldArea(new WorldPoint(3352, 2973, 1), new WorldPoint(3356, 2977, 1)), BANNER_14937),
	POLL_ROOF_THREE(new WorldArea(new WorldPoint(3360, 2977, 1), new WorldPoint(3363, 2980, 1)), GAP_14938),
	POLL_ROOF_FOUR(new WorldArea(new WorldPoint(3366, 2976, 1), new WorldPoint(3372, 2975, 1)), TREE_14939),
	POLL_ROOF_FIVE(new WorldArea(new WorldPoint(3365, 2982, 1), new WorldPoint(3370, 2987, 1)), ROUGH_WALL_14940, RooftopAgilityObstacleType.DECORATION),
	POLL_ROOF_SIX(new WorldArea(new WorldPoint(3355, 2980, 2), new WorldPoint(3366, 2986, 2)), MONKEYBARS),
	POLL_ROOF_SEVEN(new WorldArea(new WorldPoint(3357, 2991, 2), new WorldPoint(3367, 2996, 2)), TREE_14944),
	POLL_ROOF_EIGHT(new WorldArea(new WorldPoint(3356, 3000, 2), new WorldPoint(3363, 3005, 2)), DRYING_LINE);
	...
	RooftopAgilityObstacles(final WorldArea location, final int obstacleId, final RooftopAgilityObstacleType type)
	{
		this.location = location;
		this.obstacleId = obstacleId;
		this.type = type;
	...
	public RooftopAgilityObstacleType getObstacleType() { return type; }
