...
class TemplateOverlay extends OverlayPanel
{
	...
	@Inject
	private TemplateOverlay(final Client client, final TemplatePlugin plugin, final TemplateConfig config)
	{
		super(plugin);
	...
	public Dimension render(Graphics2D graphics)
	{
		...
		tableMarksComponent.addRow("Profit per hour:", String.valueOf(plugin.coinsPH));
