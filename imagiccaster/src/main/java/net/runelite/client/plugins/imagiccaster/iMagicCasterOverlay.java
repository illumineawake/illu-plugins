...
@Slf4j
@Singleton
class iMagicCasterOverlay extends OverlayPanel {
    private final Client client;
    private final iMagicCasterPlugin plugin;
    private final iMagicCasterConfig config;

    String timeFormat;
    private String infoStatus = "Starting...";

    @Inject
    private iMagicCasterOverlay(final Client client, final iMagicCasterPlugin plugin, final iMagicCasterConfig config) {
        super(plugin);
